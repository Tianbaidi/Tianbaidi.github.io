...
- **Spring 2026 Basic Mathematics Seminar** — *Organizer*
  - Reading seminar on:
    - *Fourier Analysis: An Introduction* — E. M. Stein
    - *Algebra* — M. Artin

### Projects

- [MLV Math Learning Vault](https://github.com/Tianbaidi/MLV_Math-Learning-Vault) — Math notes repository
- [HZNU Beamer Template](https://github.com/Tianbaidi/Hznu_Beamer_Template/tree/main) — LaTeX Beamer template for HZNU

### Contact

- Email: [2025212501117@stu.hznu.edu.cn](mailto:2025212501117@stu.hznu.edu.cn)
